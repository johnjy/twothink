...
return  [
	...
	// | 系统数据加密设置
	// +----------------------------------------------------------------------
	'data_auth_key' => '?(-@vI[uOGMx_SbW23+;&na^ZkyV.N]0~1,Fq=Rz', //默认数据加密KEY
	'data_cache_key'=> '?(-@vI[uOGMx_SbW23+;&na^ZkyV.N]0~1,Fq=Rz',
    // +----------------------------------------------------------------------
    // | UCenter客户端配置
    // +----------------------------------------------------------------------
    'uc_app_id'   => 1,   //应用ID
    'uc_api_type' =>'Model',    //可选值 Model / Service
    'uc_auth_key' =>'?(-@vI[uOGMx_SbW23+;&na^ZkyV.N]0~1,Fq=Rz', //加密KEY
