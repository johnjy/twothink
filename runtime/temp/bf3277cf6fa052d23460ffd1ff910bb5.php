<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"D:\www\twothink\public/../application/admin/view/default/authentication\index.html";i:1512034205;s:73:"D:\www\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
			...
			<tbody>
				<?php if(!(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty()))): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$repair): $mod = ($i % 2 );++$i;?>
					<tr >
						...
						<td><?php echo $repair['room']; ?></td>
						<td><?php echo $repair['relation']; ?></td>
                        <td><?php echo $repair['tel']; ?></td>
                        <td><?php echo $repair['card']; ?></td>
                        <td class="yanzheng"><?php echo $repair['status']==0?'未认证':'已认证'; ?></td>
						<td>
							<a class="check"id="<?php echo $repair['id']; ?>" title="查看" href="javascript:;">查看</a>
...
<script type="text/javascript">
	...
	$(".check").click(function () {
		...
		var that=$(this);
//		alert(id);
		$.getJSON("<?php echo url('edit'); ?>",{id:id},function(data){
			if(data==1){
