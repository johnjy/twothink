<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"D:\www\twothink\public/../application/admin/view/default/notice\index.html";i:1511768206;s:73:"D:\www\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;s:78:"D:\www\twothink\public/../application/admin/view/default/article\sidemenu.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<script>
	...
	<!--<div class="main-title">-->
		...
		<!--<?php if(!(empty($rightNav) || (($rightNav instanceof \think\Collection || $rightNav instanceof \think\Paginator ) && $rightNav->isEmpty()))): ?>-->
      		...
      		<!--<?php endforeach; endif; else: echo "" ;endif; ?>-->
      		<!--<?php if(isset($article)): ?>：<a href="<?php echo url('index','cate_id='.$cate_id.'&pid='.$article['id']); ?>"><?php echo $article['title']; ?></a><?php endif; ?>-->
		<!--<?php else: ?>-->
    		     <!--<?php if(empty($position) || (($position instanceof \think\Collection || $position instanceof \think\Paginator ) && $position->isEmpty())): ?>全部<?php else: ?><a href="<?php echo url('article/index'); ?>">全部</a><?php endif; ?>-->
			<!--<?php if(is_array(\think\Config::get('document_position')) || \think\Config::get('document_position') instanceof \think\Collection || \think\Config::get('document_position') instanceof \think\Paginator): if( count(\think\Config::get('document_position'))==0 ) : echo "" ;else: foreach(\think\Config::get('document_position') as $key=>$vo): ?>-->
  			     <!--<?php if($position != $key): ?><a href="<?php echo url('index',array('position'=>$key)); ?>"><?php echo $vo; ?></a><?php else: ?><?php echo $vo; endif; ?>&nbsp;-->
			<!--<?php endforeach; endif; else: echo "" ;endif; ?>-->
		<!--<?php endif; ?>-->
		<!--]-->
		<!--<?php if($allow == '0'): ?>（该分类不允许发布内容）<?php endif; ?>-->
		<!--<?php if(count($model) > 1): ?>[ 模型：<?php if(empty($model_id) || (($model_id instanceof \think\Collection || $model_id instanceof \think\Paginator ) && $model_id->isEmpty())): ?><strong>全部</strong><?php else: ?><a href="<?php echo url('index',array('pid'=>$pid,'cate_id'=>$cate_id)); ?>">全部</a><?php endif; ?>-->
			...
			<!--<?php if($model_id != $vo): ?><a href="<?php echo url('index',array('pid'=>$pid,'cate_id'=>$cate_id,'model_id'=>$vo)); ?>"><?php echo get_document_model($vo,'title'); ?></a><?php else: ?><strong><?php echo get_document_model($vo,'title'); ?></strong><?php endif; ?>&nbsp;-->
			<!--<?php endforeach; endif; else: echo "" ;endif; ?>-->
		<!--]<?php endif; ?>-->
		<!--<?php if(!(empty($groups) || (($groups instanceof \think\Collection || $groups instanceof \think\Paginator ) && $groups->isEmpty()))): ?>[ 分组：<?php if(empty($group_id) || (($group_id instanceof \think\Collection || $group_id instanceof \think\Paginator ) && $group_id->isEmpty())): ?><strong>全部</strong><?php else: ?><a href="<?php echo url('index',array('pid'=>$pid,'cate_id'=>$cate_id)); ?>">全部</a><?php endif; ?>-->
			...
			<!--<?php if($group_id != $key): ?><a href="<?php echo url('index',array('pid'=>$pid,'cate_id'=>$cate_id,'model_id'=>$model_id,'group_id'=>$key)); ?>"><?php echo $vo; ?></a><?php else: ?><strong><?php echo $vo; ?></strong><?php endif; ?>&nbsp;-->
			<!--<?php endforeach; endif; else: echo "" ;endif; ?>-->
		<!--]<?php endif; ?>-->
		<!--</h2>-->
	<!--</div>-->
