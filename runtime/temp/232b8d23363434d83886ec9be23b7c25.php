<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"D:\www\twothink\public/../application/admin/view/default/shop\index.html";i:1511925548;s:73:"D:\www\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
	...
	<div class="data-table table-striped">
		<table>
			...
			<tbody>
				<?php if(!(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty()))): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$shop): $mod = ($i % 2 );++$i;?>
					<tr>
						...
						<td><?php echo date("Y-m-d H:i:s",$shop['start_time']); ?></td>
						<td><?php echo date("Y-m-d H:i:s",$shop['end_time']); ?></td>
                        <td><?php echo $repair['intro']; ?></td>
                        <td><?php echo $shop['status']==0?'未发布':'发布'; ?></td>
						<td>
