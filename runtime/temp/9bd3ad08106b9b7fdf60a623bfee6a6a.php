<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"D:\www\twothink\public/../application/user/view/default/authentication\index.html";i:1512024215;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="main">
    ...
    <nav class="navbar navbar-default navbar-fixed-bottom">
        <div class="container-fluid text-center">
            ...
            <div class="col-xs-3">
                <p class="navbar-text"><a href="<?php echo url('home/service/index'); ?>" class="navbar-link">服务</a></p>
            </div>
            <div class="col-xs-3">
