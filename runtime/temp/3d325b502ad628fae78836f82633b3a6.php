<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"D:\www\twothink\public/../application/admin/view/default/sale\edit.html";i:1512056494;s:73:"D:\www\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
	...
	<div class="main-title">
		<h2>
			<?php echo !empty($info['id'])?'查看':'新增'; ?>房源
		</h2>
	</div>
	<form action="<?php echo url(); ?>" method="post" class="form-horizontal">
		...
		<div class="form-item">
			<label class="item-label">售价<span class="check-tips"></span></label>
			<div class="controls">
				<input type="text" class="text input-large" name="price" value="<?php echo (isset($info['price']) && ($info['price'] !== '')?$info['price']:''); ?>">
			</div>
		</div>
		<div class="form-item">
			<label class="item-label">租售形式<span class="check-tips"></span></label>
			<div class="controls">

				<input type="radio"  name="sale" value="1" >出租
				<input type="radio"  name="sale" value="2">出售
			</div>
		</div>
		<div class="form-item">
		...
		<div class="form-item">
			<label class="item-label">房源描述<span class="check-tips"></span></label>
			<div class="controls">
				<textarea style="width: 500px ;height: 150px" name="intro" ><?php echo (isset($info['intro']) && ($info['intro'] !== '')?$info['intro']:''); ?></textarea>
				<!--<input type="text" class="text input-large" name="intro" value="<?php echo (isset($info['problem']) && ($info['problem'] !== '')?$info['problem']:''); ?>">-->
			</div>
		</div>
		<div class="form-item">


			<label class="item-label">房源图片<span class="check-tips"></span></label>
